...
// --- Replace this with your deployed RWANFT address ---
const rwaNFTAddress = "0x5Ada6672E193a1E88226EE2948351d4d2a2ef410";

// --- Embed the ABI directly ---
const RWANFTABI =[
    {
      "inputs": [],
...
const provider = new ethers.JsonRpcProvider("https://api.avax.network/ext/bc/C/rpc"); // Replace with your RPC
const wallet = new ethers.Wallet(process.env.PRIVATE_KEY, provider); // Replace with your private key

const rwaNFTContract = new ethers.Contract(
  rwaNFTAddress,
  RWANFTABI,
  wallet
);
...
module.exports = {
  async mintAsset(to, metadataURI) {
    try {
