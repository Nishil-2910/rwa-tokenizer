...
// --- Replace this with your deployed Marketplace address ---
const marketplaceAddress = "0x2d004F8Cb4883166b669f13a57f27fDd07F86d23";
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Marketplace.FractionalListing",
          "name": "",
          "type": "tuple"
        }
      ],
      ...
      "outputs": [
        {
          ...
          "internalType": "struct Marketplace.NFTListing",
          "name": "",
          "type": "tuple"
        }
      ],
...
const provider = new ethers.JsonRpcProvider("https://api.avax.network/ext/bc/C/rpc"); // or your RPC
